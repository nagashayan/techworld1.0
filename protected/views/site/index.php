        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2>We Transform you From student to professional, From newbie to master, From nothing to everything</h2>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="service-item">
                                ...
                                <p>Interested in learning how to create Android apps? This Android training course is designed to quickly get you up to speed on how to build Android apps for Android devices.</p>
...
<section id="portfolio" class="portfolio">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="portfolio-item">
                                <a href="#">
                                    <img class="try img-portfolio img-responsive" src="img/portfolio-1.jpg">					
                                </a>
                            </div>
                        </div>
                        <div class="col-md-6">
                        ...
                        <img id='nextevent' class="img-portfolio img-responsive" src="img/poster.jpg" style="width: 900px; height: 400px">
                    </div>
                    <!-- /.row (nested) -->
    ...
    <aside class="call-to-action bg-primary">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h3>Our Next Event, Workshop on February 15th</h3>                    
